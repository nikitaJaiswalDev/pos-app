...
import { Card, CardContent, CardHeader, Grid, TextField, MenuItem, Select, InputLabel, Stack, Divider, FormHelperText} from '@mui/material';
import InputFile from 'components/CustomInput/InputFile';

const GeneralCard = ({ roleSlice,values, setFieldValue,errors, uploadedImage, setUploadedImage }) => (
  <Card>
